...
import {
    ExecuteIfAdmin,
    RottenPotatoItem,
} from '@plugins/items/rotten-potato/helpers/rotten-potato-helpers';
import peelPotato from '@plugins/items/rotten-potato/hooks/rotten-potato-peel';
import {
    potatoOnPlayer,
    potatoManipulatePlayerInventory,
} from '@plugins/items/rotten-potato/hooks/rotten-potato-item-on-player';
...
export default {
    ...
    hooks: [
        ...
        },
        {
            ...
            handler: (details) =>
                ExecuteIfAdmin(details, potatoManipulatePlayerInventory),
        },
        {
