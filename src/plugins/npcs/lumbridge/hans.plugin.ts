...
const handler = async ({ player, npc }) => {
    ...
    const dialogueTree = [
        ...
        (options) => [
            ...
            [
                (player) => [
                    Emote.HAPPY,
                    'Loving it so far, thanks for asking!',
                ],
                (hans) => [
                    Emote.HAPPY,
            ...
            [
                (player) => [
                    Emote.GENERIC,
                    `It's kind of cool, I guess. Bit of a weird gimmick.`,
                ],
                (hans) => [
                    Emote.HAPPY,
            ...
            [
                (player) => [
                    Emote.SKEPTICAL,
                    'Not really my cup of tea, but keep at it.',
                ],
            ...
            [
                (player) => [
                    Emote.ANGRY,
                    `Literally the worst thing I've ever seen. You disgust me on a personal level.`,
                ],
                (hans) => [
                    Emote.SAD,
                    `I-is that so?... Well I'm... I'm sorry to hear that.`,
                ],
    ...
    const dialogueSuccessful = await dialogue(
    ...
    if (dialogueSuccessful) {
        if (sadEnding) {
            ...
            player.sendMessage(
                'Hans wanders off aimlessly through the courtyard.',
            );
        }
