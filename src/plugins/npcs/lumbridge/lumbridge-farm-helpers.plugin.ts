...
const millieDialogue: npcInteractionActionHandler = async (details) =>
    dialogue(
        ...
        [
            (millie) => [
                Emote.GENERIC,
                'Hello Adventurer. Welcome to Mill Lane Mill. Can I help you?',
            ],
            (options) => [
                'Who are you?',
                [
                    ...
                    (player) => [
                        Emote.GENERIC,
                        `It's a good business to be in. People will always need flour.`,
                    ],
                    goto('tag_Mill_Flour'),
                ],
                'What is this place?',
                [
                    ...
                    (millie) => [
                        Emote.GENERIC,
                        'We take grain from the field nearby and mill into flour.',
                    ],
                    goto('tag_Mill_Flour'),
                ],
                'How do I mill flour?',
                [
                    (player, tag_Mill_Flour) => [
                        Emote.WONDERING,
                        'How do I mill flour?',
                    ],
                    (millie) => [
                    ...
                    (millie) => [
                        Emote.GENERIC,
                        'Feel free to pick wheat from our field! There always seems to be plenty ' +
                            'of wheat there.',
                    ],
                    (player) => [
                        Emote.WONDERING,
...
const gillieDialogue: npcInteractionActionHandler = async (details) =>
    dialogue(
        ...
        [
            (gillie) => [
                Emote.HAPPY,
                `Hello, I'm Gillie the Milkmaid. What can I do for you?`,
            ],
            (options) => [
                'Who are you?',
                [
                    ...
                    (gillie) => [
                        Emote.GENERIC,
                        'My name is Gillie Groats. My father is a farmer and I milk the cows for him.',
                    ],
                    (player) => [
                        Emote.WONDERING,
                        'Do you have nay buckets of milk spare?',
                    ],
                    (gillie) => [
                        Emote.GENERIC,
                ...
                [
                    ...
                    (gillie) => [
                        Emote.HAPPY,
                        `It's very easy. First you need an empty bucket to hold the milk.`,
                    ],
                    (gillie) => [
                        Emote.HAPPY,
                        `Then find a dairy cow to milk - you can't milk just any cow.`,
                    ],
                    ...
                    (gillie) => [
                        Emote.GENERIC,
                        'There are a couple very near, in this field.',
                    ],
                    (gillie) => [
                        Emote.GENERIC,
                        'Then just milk the cow and your bucket will fill with tasty, untritious milk.',
                    ],
                ],
                `I'm fine, thanks.`,
                [(player) => [Emote.GENERIC, `I'm fine, thanks.`]],
