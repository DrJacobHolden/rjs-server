        ...
        [
            ...
            (options) => [
                ...
                [
                    ...
                    (bartender) => [
                        Emote.HAPPY,
                        `No problemo. That'll be 2 coins.`,
                    ],
                    execute(() => {
                        ...
                        if (
                            hasCoins &&
                            player.inventory.amountInStack(index) >= 2
                        ) {
                            const amount =
                                player.inventory.amountInStack(index);
                            // Check inventory.
        ...
        [
            ...
            (options) => [
                        ...
                        if (!hasCoins) {
                            dialogue(
                                ...
                                [
                                    ...
                                    (cook) => [
                                        Emote.ANGRY,
                                        `Why are you asking me to sell you food if you haven't got any money? Go away!`,
                                    ],
                                ],
                            );
                        }
                ...
                [
                    ...
                    (cook) => [
                        Emote.GENERIC,
                        'Can you give my any free money?',
                    ],
                    (player) => [
                        Emote.GENERIC,
                        'Why should I give you free money?',
                    ],
                    (cook) => [
                        Emote.GENERIC,
                ...
                [
                    ...
                    (cook) => [
                        Emote.ANGRY,
                        'How dare you? I put a lot of effort into cleaning this kitchen.',
                    ],
                    (cook) => [
                        Emote.ANGRY,
                        'My daily sweat and elbow-grease keep this kitchen clean!',
                    ],
