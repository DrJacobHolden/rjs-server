...
const journalHandler: QuestJournalHandler = {
    ...
    50: (player) => {
        ...
        if (
            player.hasItemInInventory(itemIds.bucketOfMilk) ||
            quest.metadata.givenMilk
        ) {
            questLog +=
                'I have found a <col=800000>bucket of milk</col> to give to the cook.\n';
        } else {
            questLog +=
        ...
        if (
            player.hasItemInInventory(itemIds.potOfFlour) ||
            quest.metadata.givenFlour
        ) {
            questLog +=
                'I have found a <col=800000>pot of flour</col> to give to the cook.\n';
        } else {
            questLog +=
        ...
        if (player.hasItemInInventory(itemIds.egg) || quest.metadata.givenEgg) {
            questLog +=
                'I have found an <col=800000>egg</col> to give to the cook.\n';
        } else {
            questLog +=
...
function dialogueIngredientQuestions(): Function {
    return (options, tag_INGREDIENT_QUESTIONS) => [
        ...
        [
            ...
            (cook) => [
                Emote.GENERIC,
                'There is a cattle field on the other side of the river, just across ' +
        ...
        [
            ...
            (cook) => [
                Emote.GENERIC,
                `I normally get my eggs from the Groats' farm, on the other side of ` +
                    'the river.',
            ],
        ...
        [
            ...
            (options) => [
                ...
                [
                    ...
                    (cook) => [
                        Emote.SAD,
                        `*sniff* Don't talk to me about cakes...`,
                    ],
                ],
                ...
                [
                    ...
                    (cook) => [
                        Emote.SAD,
                        `No, I'm not. The world is caving in around me - I am overcome by dark feelings ` +
                            'of impending doom.',
                    ],
                    (options) => [
                        `What's wrong?`,
                        ...
                        [
                            ...
                            (player) => [
                                Emote.SKEPTICAL,
                                'Well maybe you need to take a holiday...',
                            ],
                            (cook) => [
                                Emote.SAD,
                                `That would be nice, but the Duke doesn't allow holidays for core staff.`,
                            ],
                            (player) => [
                                Emote.LAUGH,
                                'Hmm, why not run away to the sea and start a new life as a Pirate?',
                            ],
                            (cook) => [
                                Emote.SKEPTICAL,
                                'My wife gets sea sick, and I have an irrational fear of eyepatches. ' +
                ...
                [
                    ...
                    (cook) => [
                        Emote.SKEPTICAL,
                        `It's all standard cook's issue uniform...`,
                    ],
                    (player) => [
                        Emote.POMPOUS,
                        'The whole hat, apron, striped trousers ensemble - it works. It makes you ' +
                            'look like a real cook.',
                    ],
                    (cook) => [
                        Emote.ANGRY,
                        `I am a real cook! I haven't got time to be chatting about Culinary Fashion. ` +
            ...
            (options) => [
                ...
                [
                    ...
                    (cook) => [
                        Emote.HAPPY,
                        `Oh thank you, thank you. I need milk, an egg and flour. I'd be very grateful ` +
                ...
                [
                    ...
                    (cook) => [
                        Emote.ANGRY,
                        'Fine. I always knew you Adventurer types were callous beasts. ' +
...
const handInIngredientsAction: npcInteractionActionHandler = async (
    details,
) => {
    const { player, npc } = details;
    ...
    const ingredients = [
        {
            itemId: itemIds.bucketOfMilk,
            text: `Here's a bucket of milk.`,
            attr: 'givenMilk',
        },
        {
            itemId: itemIds.potOfFlour,
            text: `Here's a pot of flour.`,
            attr: 'givenFlour',
        },
    ...
    dialogueTree.push(
        ...
        (subtree, tag_NO_INGREDIENTS) => [
            (player) => [
                Emote.GENERIC,
                `I haven't got any of them yet, I'm still looking.`,
            ],
            (cook) => [
                Emote.SAD,
