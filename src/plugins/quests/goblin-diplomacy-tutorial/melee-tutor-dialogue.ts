    ...
    50: async (player, npc) => {
        await dialogue(
            ...
            [
                (harlan) => [
                    Emote.GENERIC,
                    'Greetings, adventurer. How can I assist you?',
                ],
                (player) => [
                    Emote.WONDERING,
                    'The guide in there said you could unlock my inventory and stuff.',
                ],
                (harlan) => [
                    Emote.LAUGH,
                    `I suppose I could, yes. But where's the fun in that?`,
                ],
                ...
                (harlan) => [
                    Emote.GENERIC,
                    'To that end, let me show you your inventory.',
                ],
                execute(() => {
    ...
    55: async (player, npc) => {
        await dialogue(
            ...
            [
                (harlan) => [
                    Emote.GENERIC,
                    `Speak with me once you've opened your inventory.`,
                ],
            ],
        );
    },
    60: async (player, npc) => {
        await dialogue(
            ...
            [
                (player) => [
                    Emote.SAD,
                    `Doesn't look like I had much on me...`,
                ],
                (harlan) => [
                    Emote.GENERIC,
                    'I would say the goblins likely ran through your pockets before the Guard hauled you in.',
                ],
                (harlan) => [
                    Emote.GENERIC,
                    `Lets check out your hitpoints and make sure you're in proper shape after that.`,
                ],
                execute(() => {
    ...
    70: async (player, npc) => {
        await dialogue(
            ...
            [
                ...
                (harlan) => [
                    Emote.GENERIC,
                    `I'll provide you with some starter equipment - but from there, you're on your own.`,
                ],
                (harlan) => [
                    Emote.GENERIC,
                    `But before I can do that, you'll need to open your Equipment tab.`,
                ],
                execute(() => {
    ...
    75: async (player, npc) => {
        await dialogue(
            ...
            [
                (harlan) => [
                    Emote.GENERIC,
                    `Speak with me once you've opened your equipment.`,
                ],
            ],
        );
    },
    80: async (player, npc) => {
        await dialogue(
            ...
            [
                (harlan) => [
                    Emote.GENERIC,
                    'Have this training equipment and try it on.',
                ],
                execute(() => {
    ...
    85: async (player, npc) => {
        await dialogue(
            ...
            [
                (harlan) => [
                    Emote.GENERIC,
                    'Try on the Training sword and shield and we can continue.',
                ],
            ],
        );
    },
