...
export const tiaras: Map<string, RunecraftingTiara> = new Map<
    string,
    RunecraftingTiara
>([
    [
        'air',
        {
            ...
            xp: 25.0,
            recipe: {
                ingredients: [itemIds.talismans.air, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'mind',
        {
            ...
            xp: 27.5,
            recipe: {
                ingredients: [itemIds.talismans.mind, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'water',
        {
            ...
            xp: 30,
            recipe: {
                ingredients: [itemIds.talismans.water, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'body',
        {
            ...
            xp: 37.5,
            recipe: {
                ingredients: [itemIds.talismans.body, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'earth',
        {
            ...
            xp: 32.5,
            recipe: {
                ingredients: [itemIds.talismans.earth, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'fire',
        {
            ...
            xp: 35,
            recipe: {
                ingredients: [itemIds.talismans.fire, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'cosmic',
        {
            ...
            xp: 40,
            recipe: {
                ingredients: [itemIds.talismans.cosmic, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'nature',
        {
            ...
            xp: 45,
            recipe: {
                ingredients: [itemIds.talismans.nature, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'chaos',
        {
            ...
            xp: 42.5,
            recipe: {
                ingredients: [itemIds.talismans.chaos, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'law',
        {
            ...
            xp: 47.5,
            recipe: {
                ingredients: [itemIds.talismans.law, itemIds.tiaras.blank],
            },
        },
    ],
    [
        'death',
        {
            ...
            xp: 50,
            recipe: {
                ingredients: [itemIds.talismans.death, itemIds.tiaras.blank],
            },
        },
    ],
]);

export const talismans: Map<string, RunecraftingTalisman> = new Map<
    string,
    RunecraftingTalisman
>([
...
export const altars: Map<string, RunecraftingAltar> = new Map<
    string,
    RunecraftingAltar
>([
    [
...
export const runes: Map<string, RunecraftingRune> = new Map<
    string,
    RunecraftingRune
>([
    [
...
export const combinationRunes: Map<string, RunecraftingCombinationRune> =
    new Map<string, RunecraftingCombinationRune>([
        [
            'mist',
            {
...
export function getEntityByAttr<T>(
    entities: Map<any, T>,
    attr: string,
    value: unknown,
): T | null {
...
export function getEntityIds<T>(
    entities: Map<any, T>,
    property: keyof T,
): number[] {
