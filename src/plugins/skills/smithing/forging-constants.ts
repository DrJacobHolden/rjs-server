...
export const smithables: Map<string, Map<string, Smithable>> = new Map<
    string,
    Map<string, Smithable>
>([
    [
        'dagger',
        ...
        new Map<string, Smithable>([
            ...
            [
                'adamant',
                {
                    ...
                    experience: 62.5,
                    item: {
                        itemId: itemIds.mediumHelmets.adamantite,
                        amount: 1,
                    },
                    ingredient: { itemId: itemIds.bars.adamantite, amount: 1 },
                },
 ...
 */
export const widgetItems: Map<number, Map<number, Smithable[]>> = new Map<
    number,
    Map<number, Smithable[]>
>([
    [
        itemIds.bars.bronze,
